            ...
            <tbody>
                ...
                <?php while ($linha = $resultado->fetch_assoc()): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?= htmlspecialchars($linha['prefixo_trem']) ?>
                        </td>

                        <td>
                            <?= htmlspecialchars($linha['modelo_trem']) ?>
                        </td>

                        <td>
                            <?= (int) $linha['ano_fabricacao'] ?>
                        </td>

                        <td>
                            <?= number_format((float) $linha['capacidade_toneladas'], 2, ',', '.') ?>
                        </td>
                        ...
                        <td class="acoes">
                            ...
                            <a href="formulario.php?id=<?= (int) $linha['id_trem'] ?>"
